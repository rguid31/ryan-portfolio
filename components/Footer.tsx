        ...
        <footer className="bg-gray-100 dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800">
            <div className="container mx-auto px-4 py-8">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {/* About Section */}
                    <div>
                        <h3 className="font-bold text-lg mb-3 text-gray-900 dark:text-white">Ryan Guidry</h3>
                        <p className="text-gray-600 dark:text-gray-400 text-sm">
                            Technical Writer | Data Scientist | AI/ML Developer
                        </p>
                    </div>
                ...
                <div className="mt-8 pt-6 border-t border-gray-200 dark:border-gray-800 text-center text-sm text-gray-600 dark:text-gray-400">
                    <p>© {currentYear} Ryan Guidry. All rights reserved.</p>
                </div>
            </div>
        </footer>
    );
